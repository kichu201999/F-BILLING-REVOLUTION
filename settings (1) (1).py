...
#------------Simplified 2 (logo on right side)-------------
  ...
  def bold_text():
    ...
    #     memaiframe.config(font=(fontStyle,fontSize,'bold'))

    # if text_property['weight']=='bold':
    #     memaiframe.config(font=(fontStyle,fontSize,'normal'))    
  ...
  def italic_text():
    ...
    #     memaiframe.config(font=(fontStyle,fontSize,'italic'))

    # if text_property['slant']=='italic':
    #     memaiframe.config(font=(fontStyle,fontSize,'roman'))
  ...
  def underline_text():
    ...
    # memaiframe.config(font = ("Arial", 10, "underline"))

    # underline_font = font.Font(memaiframe, memaiframe.cget("font"))
    # # underline_font.configure(slant="roman")

    # memaiframe.tag_configure("underline", font=underline_font)

    # current_tags = memaiframe.tag_names()

    # if "underline" in current_tags:
    #   memaiframe.tag_remove("underline", 1.0, END)
    # else:
    #   memaiframe.tag_add("underline", 1.0, END)
    
    # text_property=font.Font(font=memaiframe.cget("font")).actual()
  ...
  #   content=memaiframe.selection_get()
  #   print(content)
  #   memaiframe.insert(END, content, hyperlink.add(partial(webbrowser.open, hype)))
  #   content.replace()
  ...
  #   hypbtn1 = Button(top,text="OK",width=10, command=lambda:add_link.destroy())
...
################################### tab09 ###########################
  ...
  if not podata:
    ...
    pcombo.insert(0, podata[42])
  pcombo.place(x=15 ,y=160)
